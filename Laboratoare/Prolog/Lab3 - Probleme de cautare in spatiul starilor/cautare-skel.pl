...
initial_state(misionari, state(vest, 0, 0, 3, 3)).
...
next_state(misionari, state(Mal1, NM_Est1, NC_Est1, NM_Vest1, NC_Vest1), state(Mal2, NM_Est2, NC_Est2, NM_Vest2, NC_Vest2)) :-
    opus(Mal1, Mal2),
